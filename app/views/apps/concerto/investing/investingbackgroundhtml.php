...
<div class="uk-container jtc-tools-formsection">
    <h1 class="atr-growing am"><?php echo $this->headerLabel; ?></h1>
    ...
    <div uk-grid hidden>
        <div class="uk-width-1-3@m uk-flex uk-flex-middle uk-flex-right">
            <h4 class="uk-text-light title_font">Contributions per month</h4>
        </div>
        <div class="uk-width-2-3@m">
            <div class="uk-margin-small ">
                <div class="uk-width-1-1 atr-form-inputs uk-position-relative"
                    uk-tooltip="title: On average this is how much I contribute to my pension plan; delay: 500">
                    <span class="uk-form-icon currency-input"><?php echo $_COOKIE['selectedcurrencyvalue'];?></span>
                    <input min="0" max="10000" class="uk-input" name="Contributions_per_annum"
                        id="Contributions_per_annum" type="text" placeholder=""
                        value="0"
                        readonly>
                </div>
                <div class="uk-text-italic">If you are still making contributions, please start the survey again by selecting <a href="<?php echo website_url($this->controller.'/planting');?>">Contributing</a>.</div>
            </div>
        </div>
    </div>
    ...
    <div class="uk-text-center">
        <div class="uk-button-group uk-button-group-pill uk-width-1-3 uk-margin-medium-top">
            <button type="button" class="uk-button uk-button-default uk-text-capitalize uk-width-1-2"
                onClick="window.location='<?php echo website_url($this->controller.'/growing');?>'">Back</button>
