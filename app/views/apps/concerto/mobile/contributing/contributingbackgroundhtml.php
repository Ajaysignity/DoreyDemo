...
<div class="uk-container jtc-tools-formsection">
    ...
    <div class="uk-hidden@m">
        <ul uk-accordion>
            ...
            <li> <a class="uk-accordion-title" href>Contributions per month <span id="contPerMonth"
                        class="uk-text-small uk-text-truncate"></span></a>
                <div class="uk-accordion-content">
                            ...
                            <div class="uk-width-1-3">
                                <div class="atr-form-inputs"
                                    ...
                                    <div class="uk-inline"><span class="uk-form-icon currency-input">%</span>
                                        <input class="uk-input uk-width-1-1" name="Contributions_percentage" id="Contributions_percentage" type="number" placeholder="0.00" value="<?php echo ( !empty($info->Contributions_percentage) ? ($info->Contributions_percentage) : '' ); ?>" oninput="validateInputPercentage(event)" min="0" step="0.01">
                                    </div>
                                </div>
                            </div>
                            <div class="uk-width-expand">
                                <div class="atr-form-inputs uk-width-expand"
                                    ...
                                    <div class="uk-inline uk-width-expand"><span class="uk-form-icon currency-input"><?php echo $_COOKIE['selectedcurrencyvalue'];?></span>
									 <input class="uk-input uk-width-1-1" name="Contributions_per_annum" id="Contributions_per_annum" type="text" min="10" max="10000" autocomplete="off" onInput="numberWithCommas('Contributions_per_annum');" value="<?php echo ( !empty($info->Contributions_per_annum) ? number_format($info->Contributions_per_annum) : '' ); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
