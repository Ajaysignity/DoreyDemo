...
<div>
    <div class="uk-container">
        ...
        <div class="atr-primary-nav">
            <?php echo doreyjtcStepsmobilemenus('liquidity'); ?>
        </div>
        ...
        <div class='wrap'>
            <input id='planting_liquidity_range' type='range' name="withdraw_percentage" value="<?php echo number_format($info->withdraw_percentage); ?>" />
        </div>
        <div class="uk-text-center">
            <div class="uk-button-group uk-button-group-pill uk-width-1-3 uk-margin-medium-top">
                <button class="uk-button uk-button-default uk-text-capitalize uk-width-1-2"
                    onClick="window.location='<?php echo website_url($this->controller.'/withdrawing-missing-out');?>'"
...
[type=range]+output {
    ...
    background: radial-gradient(#fff 39%, transparent 39.5%), conic-gradient(#c2207e calc(var(--val)*1%), #e1e1e1 0%);
    margin-top: -1.6em;
    /*    margin-top: -1.1em;*/
}
