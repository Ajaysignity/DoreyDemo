    ...
    <div class="uk-container">
        ...
        <div class="atr-primary-nav">
            ...
            <ul class="uk-child-width-expand uk-margin-small-top" uk-tab>
                <li class="uk-active"
                    onClick="window.location='<?php echo website_url($this->controller.'/withdrawing-risk');?>'"><a>Risk <i uk-icon="icon: question; ratio: .6"
                ...
                <li class=""
                    onClick="window.location='<?php echo website_url($this->controller.'/withdrawing-results');?>'"><a>Projection</a>
                </li>
            </ul>
        </div>
