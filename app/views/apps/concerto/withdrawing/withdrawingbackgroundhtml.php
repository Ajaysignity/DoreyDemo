    ...
    <div uk-grid hidden>
        ...
        <div class="uk-width-2-3@m">
            <div class="uk-margin-small ">
                ...
                <div class="uk-text-italic">If you are still making contributions, please start the survey again by
                    selecting <a href="<?php echo website_url($this->controller.'/contributing');?>">Contributing</a>.</div>
            </div>
        </div>
    </div>
    ...
    <div class="uk-text-center">
        <div class="uk-button-group uk-button-group-pill uk-width-1-3 uk-margin-medium-top">
            <button type="button" class="uk-button uk-button-default uk-text-capitalize uk-width-1-2"
                onClick="window.location='<?php echo website_url($this->controller.'/investing');?>'">Back</button>
