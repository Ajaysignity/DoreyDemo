...
<div class="uk-modal-dialog uk-modal-body">
	<?php echo form_open(base_url(), 'class="uk-form-stacked RenameNewFolderForm" method="POST" data-action="savenewsolutionfolder" data-controller="solutions"');?>
		<div class="uk-margin">
			...
			<div class="uk-form-controls">
				...
				<input name="foldertype" type="hidden" value="rename">
				...
				<input name="FolderPrntQIDS" type="hidden" value="<?php echo (isset($FolderPrntQIDS) ? $FolderPrntQIDS : '');?>">
			</div>
		</div>
		<div class="uk-text-right">
			<button class="uk-button uk-button-default uk-modal-close uk-border-pill" type="button">Cancel</button>
			<button class="uk-button uk-button-primary uk-border-pill" type="submit" onclick="ValidateSolutionFormSubmit('RenameNewFolderForm','Save');">Save</button>
		</div>
	<?php echo form_close(); ?>
</div>